    ...
    def spearmanProcess(self,motion_segment_pleft, motion_segment_pright,wf):
        ...
        def fisher_z(r):
            try:
                ...
                # wf.write("This is Z: "+str(z)+"  This is CC: "+str(r))
                return z
            except Exception as e:
                wf.write ("\nError RRR: "+ str(e)+" r is "+ str (r)+"\n")
                return 10000, 10000
        ...
        # to convert nan cc
            ...
            if self.pvalue_coef>0.05:
                ...
                self.fisherz = fisher_z(self.spear_coef)
        ...
        return self.spear_coef, self.pvalue_coef,self.fisherz